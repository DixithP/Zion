...
<body>
	...
	<form action="addbook" method="post" class="form-signin" >
		...
		<ul>
   			...
   			<li>		<label for="author"  class="title">Author</label>
  		...
  		<!-- <p class="info"> Dint find the author looking for..? Add new author</p> -->

  		   	<li>		<label for="Author"  class="title"> New Author</label>
    					<input type="text" class="form-control" name="newauthor" >
    		</li>

    		<li>		<label for="rating"  class="title">Rating:</label>
  		   	...
  		   	<li>		<label for="review"  class="title">Review:</label>
